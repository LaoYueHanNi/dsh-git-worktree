 ...
 */
export function resolveRootDir(rootDir, home, envHome) {
 ...
 */
export function planLegacyMigration(legacy, userLayer) {
    if (userLayer !== undefined && Object.hasOwn(userLayer, 'rootDir'))
        return undefined;
 ...
 */
export async function loadLegacySettings(file) {
    let raw;
    try {
...
export function migratedFileOf(file) {
