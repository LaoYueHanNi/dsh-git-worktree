window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function requestWorktreeCutout(repoPath, branch) {
			return post(ROUTE_WORKTREE, {
				repoPath,
				branch,
				cutout: true
		...
		*/
		...
		var BranchChip_module_default = {
			...
			"menuToolButtonFetching": "menuToolButtonFetching_2006230319",
		...
		*/
		function BranchMenu({ open, anchorRef, rows, currentBranch, confirm, onSelect, canCreate, onCreate, busy, onFetch, fetchBusy, onUpdate, updateBusy, onClose, t }) {
			...
			* button's scope. */
			const folderPaths = (0, react.useMemo)(() => collectFolderPaths(tree), [tree]);
			...
			(0, react.useEffect)(() => {
				...
				setExpanded(currentRows.length > TREE_MIN_ROWS ? chainExpanded(currentBranch) : new Set(collectFolderPaths(buildTree(currentRows))));
			}, [open, currentBranch]);
			(0, react.useEffect)(() => {
				...
				(0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: updateBusy ? `${BranchChip_module_default.menuToolButton} ${BranchChip_module_default.menuToolButtonFetching}` : BranchChip_module_default.menuToolButton,
								title: t("menuUpdate"),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: fetchBusy ? `${BranchChip_module_default.menuToolButton} ${BranchChip_module_default.menuToolButtonFetching}` : BranchChip_module_default.menuToolButton,
								title: t("menuFetch"),
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								role: "presentation",
								ref: holdRowsCenter,
								children: [needle === "" ? renderTree(tree, 0) : renderSearch(tree, 0), visible.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		*/
		function ChipConfirm({ anchorRef, ask, confirmLabel, cancelLabel, busy, onConfirm, onCancel }) {
		...
		function BranchChipDock({ session, sessionId, useSessions, adoptWorktree, t }) {
			...
			* branch), register the directory, hop sessions. */
			const doWorktree = (0, react.useCallback)((branch, cutout) => runGuarded(async () => {
				if (cwd === void 0) return "no session directory";
				const result = cutout ? await requestWorktreeCutout(cwd, branch) : await requestWorktree(cwd, branch);
				if (!result.ok) return result.error;
				try {
			...
			* dialog (whichever is showing). */
			const confirmBundle = confirm === null ? null : {
				ask: confirm.kind === "worktree-cutout" ? t("worktreeAskCutOut", { branch: confirmLocalName }) : confirm.kind === "worktree" ? t(existingWorktree !== void 0 ? "worktreeAskReuse" : "worktreeAskNew", { branch: confirmLocalName }) : t("switchAsk", { branch: confirm.branch }),
				confirmLabel: busy ? confirm.kind === "worktree" || confirm.kind === "worktree-cutout" ? t("worktreeBusy") : t("switchBusy") : t("actionConfirm"),
				cancelLabel: t("actionCancel"),
				busy,
				onConfirm: () => {
					if (confirm.kind === "worktree" || confirm.kind === "worktree-cutout") doWorktree(confirm.branch, confirm.kind === "worktree-cutout");
		...
		*/
		...
		const tagId = "@laoyuehanni/dsh-git-worktree/GitWorktreeCard.module.css";
