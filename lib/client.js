	...
	factory: (require) => {
		...
		*/
		...
		var BranchChip_module_default = {
			"input": "input_2098199083",
			"left": "left_2098199083",
			"trigger": "trigger_2098199083",
			"dock": "dock_2098199083",
			"divider": "divider_2098199083",
			"chip": "chip_2098199083",
			"branch": "branch_2098199083",
			"check": "check_2098199083",
			"checkOn": "checkOn_2098199083",
			"box": "box_2098199083",
			"checkLabel": "checkLabel_2098199083",
			"popCard": "popCard_2098199083",
			"popAsk": "popAsk_2098199083",
			"popSubject": "popSubject_2098199083",
			"popActions": "popActions_2098199083",
			"menuRows": "menuRows_2098199083",
			"body": "body_2098199083",
			"menuCard": "menuCard_2098199083",
			"menuToolbar": "menuToolbar_2098199083",
			"menuToolButton": "menuToolButton_2098199083",
			"menuToolButtonRunning": "menuToolButtonRunning_2098199083",
			"menuMain": "menuMain_2098199083",
			"menuHeading": "menuHeading_2098199083",
			"menuRow": "menuRow_2098199083",
			"menuRowLocked": "menuRowLocked_2098199083",
			"menuRowSelected": "menuRowSelected_2098199083",
			"menuRowPicked": "menuRowPicked_2098199083",
			"menuRowLabel": "menuRowLabel_2098199083",
			"menuRowArrow": "menuRowArrow_2098199083",
			"menuSearchMark": "menuSearchMark_2098199083",
			"menuGroup": "menuGroup_2098199083",
			"menuGroupTop": "menuGroupTop_2098199083",
			"menuGroupLabel": "menuGroupLabel_2098199083",
			"menuGroupChevron": "menuGroupChevron_2098199083",
			"menuGroupChevronOpen": "menuGroupChevronOpen_2098199083",
			"menuGroupCount": "menuGroupCount_2098199083",
			"menuEmpty": "menuEmpty_2098199083",
			"menuSearchWrap": "menuSearchWrap_2098199083",
			"menuSearch": "menuSearch_2098199083",
			"menuToolButtonOn": "menuToolButtonOn_2098199083",
			"menuCreate": "menuCreate_2098199083",
			"menuCreateHintBad": "menuCreateHintBad_2098199083"
		};
		//#endregion
		...
		*/
		...
		function BranchChipDock({ sessionId, useSession, adoptWorktree, sessionsList, t }) {
			const blank = useSession((snapshot) => snapshot.blank);
			const cwd = (0, react.useSyncExternalStore)(sessionsList.subscribe, () => sessionsList.getSnapshot().byId[sessionId])?.cwd;
			...
			* git's default behavior, not worth a third line. */
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					...
					}), blank && !inLinkedWorktree && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		*/
		...
		var GitWorktreeCard_module_default = {
			"card": "card_1542936780",
			"cardOpen": "cardOpen_1542936780",
			"header": "header_1542936780",
			"headText": "headText_1542936780",
			"name": "name_1542936780",
			"description": "description_1542936780",
			"pending": "pending_1542936780",
			"chevron": "chevron_1542936780",
			"chevronOpen": "chevronOpen_1542936780",
			"body": "body_1542936780",
			"note": "note_1542936780",
			"field": "field_1542936780",
			"fieldLabel": "fieldLabel_1542936780",
			"input": "input_1542936780",
			"inputRow": "inputRow_1542936780",
			"browse": "browse_1542936780",
			"hint": "hint_1542936780",
			"footer": "footer_1542936780",
			"failed": "failed_1542936780",
			"discard": "discard_1542936780",
			"save": "save_1542936780",
			"toggleRow": "toggleRow_1542936780",
			"toggleText": "toggleText_1542936780",
			"toggleLabel": "toggleLabel_1542936780",
			"toggleMark": "toggleMark_1542936780",
			"toggleHint": "toggleHint_1542936780",
			"toggleNote": "toggleNote_1542936780",
			"toggleControl": "toggleControl_1542936780",
			"spinner": "spinner_1542936780",
			"toggle": "toggle_1542936780"
		};
		//#endregion
		...
		*/
		...
		const GROUP_BOOT_STORAGE_KEY = "dsh-git-worktree.sidebar.groupSidebar";
		/**
		...
		*/
		...
		function saveGroupSidebarBoot(enabled) {
			if (typeof localStorage === "undefined") return;
			try {
		...
		const FACTS_STORAGE_KEY = "dsh-git-worktree.sidebar.facts.v1";
		/** Parse one WorkspaceGitFacts value; undefined = malformed. */
		function parseWorkspaceGitFacts(value) {
			if (typeof value !== "object" || value === null || Array.isArray(value)) return void 0;
			const record = value;
			if (typeof record.repoRoot !== "string" || record.repoRoot === "") return void 0;
			if (typeof record.repoName !== "string") return void 0;
			if (record.branch !== null && typeof record.branch !== "string") return void 0;
			if (typeof record.main !== "boolean") return void 0;
			return {
		...
		function parseFactsRecord(value) {
		...
		*/
		function factsForSignature(signature, live, cached) {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/@deepseek-ai+dsh-util-works_6e61a435a33302346cc90b5c6544222a/node_modules/@deepseek-ai/dsh-util-workspace-path/lib/index.js
		/**
		...
		*/
		...
		//#endregion
		//#region \0git-worktree-css:C:\Users\OYW\.dsh\gitworktree\dsh-worktree-feature-0.1.2-alpha.5\src\client\sidebar-rows.module.css?inline
		const css$1 = "/* Native Rows.module_667592273.css_667592273 transplanted 1:1 (DSW tokens, row-in, reduced-motion).\n * Drag marker classes (dropBefore/dropAfter) are kept for P3; unused in P2. */\n\n.projectRow_667592273,\n.sessionRow_667592273 {\n  cursor: pointer;\n  user-select: none;\n  color: var(--dsw-alias-label-primary);\n  border-radius: 8px;\n  align-items: center;\n  gap: 6px;\n  padding: 0 8px;\n  display: flex;\n}\n\n.projectRow_667592273:hover,\n.sessionRow_667592273:hover,\n.sessionRow_667592273.selected_667592273 {\n  background: var(--dsw-alias-interactive-bg-hover);\n}\n\n.searchResultRow_667592273 {\n  box-sizing: border-box;\n  cursor: pointer;\n  text-align: left;\n  width: 100%;\n  min-height: 48px;\n  color: var(--dsw-alias-label-primary);\n  background: 0 0;\n  border: none;\n  border-radius: 8px;\n  flex-direction: column;\n  align-items: stretch;\n  padding: 4px 8px;\n  display: flex;\n}\n\n.searchResultRow_667592273:hover,\n.searchResultRow_667592273.selected_667592273 {\n  background: var(--dsw-alias-interactive-bg-hover);\n}\n\n.searchResultHeading_667592273 {\n  align-items: center;\n  min-width: 0;\n  display: flex;\n}\n\n.searchResultTitle_667592273 {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  min-width: 0;\n  margin-left: 4px;\n  font-size: 14px;\n  line-height: 20px;\n  overflow: hidden;\n}\n\n.searchResultMeta_667592273 {\n  align-items: center;\n  gap: 6px;\n  min-width: 0;\n  margin-left: 20px;\n  display: flex;\n}\n\n.searchResultWorkspace_667592273,\n.searchResultSnippet_667592273 {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  font-size: 12px;\n  line-height: 17px;\n  overflow: hidden;\n}\n\n.searchResultWorkspace_667592273 {\n  max-width: 40%;\n  color: var(--dsw-alias-label-tertiary);\n  flex: none;\n}\n\n.searchResultSnippet_667592273 {\n  min-width: 0;\n  color: var(--dsw-alias-label-secondary);\n  flex: 1;\n}\n\n.projectRow_667592273 {\n  box-sizing: border-box;\n  align-items: center;\n  height: 34px;\n}\n\n.projectRow_667592273 .rowActions_667592273 {\n  height: 20px;\n}\n\n.sessionRow_667592273 {\n  height: 32px;\n  animation: row-in 0.15s var(--ds-ease-in-out);\n  gap: 0;\n}\n\n.sessionRow_667592273 .title_667592273 {\n  margin: 0 6px 0 4px;\n}\n\n.flatSessionRowWithoutStatus_667592273 .title_667592273 {\n  margin-left: 0;\n}\n\n@keyframes row-in {\n  0% { opacity: 0; }\n}\n\n.slot_667592273 {\n  width: 16px;\n  height: 20px;\n  color: var(--dsw-alias-label-tertiary);\n  flex: none;\n  justify-content: center;\n  align-items: center;\n  display: inline-flex;\n}\n\n.visuallyHidden_667592273 {\n  clip: rect(0 0 0 0);\n  white-space: nowrap;\n  width: 1px;\n  height: 1px;\n  position: absolute;\n  overflow: hidden;\n}\n\n.folderActive_667592273 {\n  color: var(--dsw-alias-state-business-primary);\n}\n\n.projectRow_667592273 .chevron_667592273 {\n  display: none;\n}\n\n.projectRow_667592273:hover .chevron_667592273 {\n  display: inline-flex;\n}\n\n.projectRow_667592273:hover .folder_667592273 {\n  display: none;\n}\n\n.arrow_667592273 {\n  transition: transform 0.15s var(--ds-ease-in-out);\n}\n\n.arrowOpen_667592273 {\n  transform: rotate(90deg);\n}\n\n.projectText_667592273 {\n  flex-direction: column;\n  flex: 1;\n  gap: 2px;\n  min-width: 0;\n  display: flex;\n}\n\n.title_667592273 {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  min-width: 0;\n  font-size: 14px;\n  line-height: 20px;\n  overflow: hidden;\n}\n\n/* Virtual (unregistered) directory rows read one weight lighter than real\n * workspace rows — together with the dashed folder glyph, the whole row is\n * distinguishable at a glance. */\n.strayRow_667592273 .title_667592273 {\n  color: var(--dsw-alias-label-secondary);\n}\n\n.renameInput_667592273 {\n  border: 0.5px solid var(--dsw-alias-border-l4);\n  background: var(--dsw-alias-button-elevated-fill);\n  min-width: 0;\n  color: inherit;\n  border-radius: 4px;\n  outline: none;\n  padding: 0 2px;\n  font-size: 14px;\n  line-height: 20px;\n}\n\n.sessionRow_667592273 .title_667592273 {\n  flex: 1;\n}\n\n.meta_667592273 {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  color: var(--dsw-alias-label-tertiary);\n  font-size: 12px;\n  line-height: 20px;\n  overflow: hidden;\n}\n\n.time_667592273 {\n  color: var(--dsw-alias-label-tertiary);\n  flex: none;\n  font-size: 12px;\n  line-height: 20px;\n}\n\n.dot_667592273 {\n  flex: none;\n}\n\n.rowActions_667592273 {\n  flex: none;\n  align-items: center;\n  gap: 12px;\n  display: none;\n}\n\n.projectRow_667592273:hover .rowActions_667592273,\n.sessionRow_667592273:hover .rowActions_667592273,\n.projectRow_667592273.menuOpen_667592273 .rowActions_667592273,\n.sessionRow_667592273.menuOpen_667592273 .rowActions_667592273 {\n  display: inline-flex;\n}\n\n.sessionRow_667592273:hover .time_667592273,\n.sessionRow_667592273.menuOpen_667592273 .time_667592273 {\n  display: none;\n}\n\n.projectRow_667592273.menuOpen_667592273,\n.sessionRow_667592273.menuOpen_667592273 {\n  background: var(--dsw-alias-interactive-bg-hover);\n}\n\n/* P3: session drag insertion markers (unused in P2). */\n.sessionRow_667592273.dropBefore_667592273,\n.sessionRow_667592273.dropAfter_667592273 {\n  position: relative;\n}\n\n.sessionRow_667592273.dropBefore_667592273:before,\n.sessionRow_667592273.dropAfter_667592273:after {\n  content: \"\";\n  z-index: 1;\n  background:\n    linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat,\n    linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat,\n    linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;\n  pointer-events: none;\n  height: 12px;\n  position: absolute;\n  left: 0;\n  right: 4px;\n}\n\n.sessionRow_667592273.dropBefore_667592273:before {\n  top: -7px;\n}\n\n.sessionRow_667592273.dropAfter_667592273:after {\n  bottom: -7px;\n}\n\n.hoverContent_667592273 {\n  flex-direction: column;\n  gap: 8px;\n  display: flex;\n}\n\n.hoverTitle_667592273 {\n  color: #fff;\n  overflow-wrap: break-word;\n  font-size: 14px;\n  line-height: 20px;\n}\n\n.hoverPath_667592273 {\n  color: #cfd3d6;\n  word-break: break-all;\n  font-size: 12px;\n  line-height: 16px;\n}\n\n.hoverTime_667592273 {\n  color: #cfd3d6;\n  font-size: 12px;\n  line-height: 16px;\n}\n\n.hoverStatus_667592273 {\n  color: #adb2b8;\n  align-items: center;\n  gap: 8px;\n  font-size: 12px;\n  line-height: 20px;\n  display: flex;\n}\n\n.iconButton_667592273 {\n  cursor: pointer;\n  width: 16px;\n  height: 16px;\n  color: var(--dsw-alias-label-tertiary);\n  background: 0 0;\n  border: none;\n  border-radius: 4px;\n  flex: none;\n  justify-content: center;\n  align-items: center;\n  padding: 0;\n  display: inline-flex;\n}\n\n.iconButton_667592273:hover {\n  color: var(--dsw-alias-label-primary);\n}\n\n.chevron_667592273 {\n  color: var(--dsw-alias-label-caption);\n}\n\n.repoCount_667592273 {\n  flex: none;\n  margin-left: 8px;\n  color: var(--dsw-alias-label-tertiary);\n  font-size: 12px;\n  line-height: 20px;\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .sessionRow_667592273,\n  .arrow_667592273 {\n    transition: none;\n    animation: none;\n  }\n}\n";
		...
		var sidebar_rows_module_default = {
			"module": "module_667592273",
			"css": "css_667592273",
			"projectRow": "projectRow_667592273",
			"sessionRow": "sessionRow_667592273",
			"selected": "selected_667592273",
			"searchResultRow": "searchResultRow_667592273",
			"searchResultHeading": "searchResultHeading_667592273",
			"searchResultTitle": "searchResultTitle_667592273",
			"searchResultMeta": "searchResultMeta_667592273",
			"searchResultWorkspace": "searchResultWorkspace_667592273",
			"searchResultSnippet": "searchResultSnippet_667592273",
			"rowActions": "rowActions_667592273",
			"title": "title_667592273",
			"flatSessionRowWithoutStatus": "flatSessionRowWithoutStatus_667592273",
			"slot": "slot_667592273",
			"visuallyHidden": "visuallyHidden_667592273",
			"folderActive": "folderActive_667592273",
			"chevron": "chevron_667592273",
			"folder": "folder_667592273",
			"arrow": "arrow_667592273",
			"arrowOpen": "arrowOpen_667592273",
			"projectText": "projectText_667592273",
			"strayRow": "strayRow_667592273",
			"renameInput": "renameInput_667592273",
			"meta": "meta_667592273",
			"time": "time_667592273",
			"dot": "dot_667592273",
			"menuOpen": "menuOpen_667592273",
			"dropBefore": "dropBefore_667592273",
			"dropAfter": "dropAfter_667592273",
			"hoverContent": "hoverContent_667592273",
			"hoverTitle": "hoverTitle_667592273",
			"hoverPath": "hoverPath_667592273",
			"hoverTime": "hoverTime_667592273",
			"hoverStatus": "hoverStatus_667592273",
			"iconButton": "iconButton_667592273",
			"repoCount": "repoCount_667592273"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0git-worktree-css:C:\Users\OYW\.dsh\gitworktree\dsh-worktree-feature-0.1.2-alpha.5\src\client\GroupedSidebar.module.css?inline
		const css = "/* Native WorkspaceBrowser.module_871918107.css_871918107 + WorkspacePicker.module_871918107.css_871918107 transplanted\n * 1:1 (DSW tokens, search expand, reduced-motion). Drag classes\n * (workspaceDrop*, listTopDrop*) are kept for P3; unused in P2.\n * Overlay: memberIndent / sessionsIndent for the repo-grouped tree. */\n\n.root_871918107 {\n  --dsh-session-list-edge-inset: var(--dsh-sidebar-inline-padding);\n  --dsh-session-list-scrollbar-width: 8px;\n  --dsh-session-list-scrollbar-offset: 2px;\n  box-sizing: border-box;\n  min-height: 0;\n  padding-right: var(--dsh-session-list-edge-inset);\n  flex-direction: column;\n  flex: 1;\n  display: flex;\n}\n\n.root_871918107.rail_871918107 {\n  padding-right: 0;\n}\n\n.iconButton_871918107 {\n  cursor: pointer;\n  width: 28px;\n  height: 28px;\n  color: var(--dsw-alias-label-secondary);\n  background: 0 0;\n  border: none;\n  border-radius: 50%;\n  corner-shape: round;\n  flex: none;\n  justify-content: center;\n  align-items: center;\n  padding: 0;\n  display: inline-flex;\n}\n\n.iconButton_871918107:hover {\n  background: var(--dsw-alias-interactive-bg-hover);\n}\n\n.sectionHeader_871918107 {\n  box-sizing: border-box;\n  height: 36px;\n  color: var(--dsw-alias-label-tertiary);\n  border-radius: 12px;\n  flex: none;\n  justify-content: flex-end;\n  align-items: center;\n  gap: 4px;\n  margin-bottom: 4px;\n  padding-left: 4px;\n  display: flex;\n  overflow: hidden;\n}\n\n.root_871918107:not(.rail_871918107) .sectionHeader_871918107 {\n  margin-top: 2px;\n  margin-right: -4px;\n}\n\n.sectionLabel_871918107 {\n  white-space: nowrap;\n  opacity: 1;\n  visibility: visible;\n  min-width: 0;\n  max-width: 45%;\n  transition: max-width 0.18s var(--ds-ease-in-out), margin-right 0.18s var(--ds-ease-in-out), opacity 0.12s var(--ds-ease-in-out), transform 0.18s var(--ds-ease-in-out), visibility 0s linear;\n  flex: none;\n  line-height: 20px;\n  overflow: hidden;\n}\n\n.sectionLabelHidden_871918107 {\n  opacity: 0;\n  visibility: hidden;\n  max-width: 0;\n  margin-right: -4px;\n  transition-delay: 0s, 0s, 0s, 0s, 0.18s;\n  transform: translate(-4px);\n}\n\n.searchSlot_871918107 {\n  box-sizing: border-box;\n  min-width: 0;\n  max-width: 28px;\n  transition: max-width 0.18s var(--ds-ease-in-out), padding-left 0.18s var(--ds-ease-in-out);\n  flex: 1;\n  align-items: center;\n  margin-left: auto;\n  padding-left: 0;\n  display: flex;\n}\n\n.searchSlotExpanded_871918107 {\n  max-width: 100%;\n  padding-left: 0;\n}\n\n.headerActions_871918107 {\n  opacity: 1;\n  visibility: visible;\n  max-width: 60px;\n  transition: max-width 0.18s var(--ds-ease-in-out), opacity 0.12s var(--ds-ease-in-out), transform 0.18s var(--ds-ease-in-out), visibility 0s linear;\n  flex: none;\n  align-items: center;\n  gap: 4px;\n  display: flex;\n  overflow: hidden;\n}\n\n.headerActionsHidden_871918107 {\n  opacity: 0;\n  visibility: hidden;\n  pointer-events: none;\n  max-width: 0;\n  transition-delay: 0s, 0s, 0s, 0.18s;\n  transform: translate(4px);\n}\n\n.search_871918107 {\n  box-sizing: border-box;\n  cursor: text;\n  width: 100%;\n  height: 28px;\n  color: var(--dsw-alias-label-secondary);\n  transition: width 0.18s var(--ds-ease-in-out), padding 0.18s var(--ds-ease-in-out), border-color 0.18s var(--ds-ease-in-out), background-color 0.18s var(--ds-ease-in-out);\n  background: 0 0;\n  border: none;\n  border-radius: 50%;\n  corner-shape: round;\n  flex: none;\n  align-items: center;\n  gap: 0;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  overflow: hidden;\n}\n\n.searchExpanded_871918107 {\n  border: 0.5px solid var(--dsw-alias-border-l4);\n  width: calc(100% + 4px);\n  height: 30px;\n  color: var(--dsw-alias-label-caption);\n  background: 0 0;\n  border-radius: 10px;\n  margin-inline: -2px;\n  padding: 0 4px 0 0;\n}\n\n.searchButton_871918107 {\n  cursor: pointer;\n  width: 28px;\n  height: 28px;\n  color: inherit;\n  background: 0 0;\n  border: none;\n  border-radius: 50%;\n  corner-shape: round;\n  flex: none;\n  justify-content: center;\n  align-items: center;\n  padding: 0;\n  display: inline-flex;\n}\n\n.searchExpanded_871918107 .searchButton_871918107 {\n  width: 28px;\n  height: 30px;\n}\n\n.searchButton_871918107:hover {\n  background: var(--dsw-alias-interactive-bg-hover);\n}\n\n.searchExpanded_871918107 .searchButton_871918107:hover {\n  background: 0 0;\n}\n\n.searchInput_871918107 {\n  opacity: 0;\n  pointer-events: none;\n  width: 0;\n  min-width: 0;\n  color: var(--dsw-alias-label-primary);\n  transition: opacity 0.12s var(--ds-ease-in-out);\n  background: 0 0;\n  border: none;\n  outline: none;\n  flex: 1;\n  font-size: 13px;\n  line-height: 18px;\n}\n\n.searchExpanded_871918107 .searchInput_871918107 {\n  opacity: 1;\n  pointer-events: auto;\n  margin-left: -2px;\n}\n\n.searchInput_871918107::placeholder {\n  color: var(--dsw-alias-label-tertiary);\n}\n\n.clearButton_871918107 {\n  cursor: pointer;\n  width: 24px;\n  height: 24px;\n  color: var(--dsw-alias-label-secondary);\n  background: 0 0;\n  border: none;\n  border-radius: 50%;\n  corner-shape: round;\n  flex: none;\n  justify-content: center;\n  align-items: center;\n  padding: 0;\n  display: inline-flex;\n}\n\n.clearButton_871918107:hover {\n  background: var(--dsw-alias-interactive-bg-hover);\n}\n\n.rail_871918107 .sectionHeader_871918107 {\n  justify-content: flex-start;\n  gap: 0;\n  margin-bottom: 12px;\n  padding-left: 0;\n}\n\n.rail_871918107 .headerActions_871918107 {\n  max-width: none;\n}\n\n.rail_871918107 .iconButton_871918107 {\n  width: 36px;\n  height: 36px;\n  color: var(--dsw-alias-label-primary);\n}\n\n.rail_871918107 .search_871918107 {\n  background: 0 0;\n  border-color: #0000;\n  gap: 0;\n  width: 36px;\n  height: 36px;\n  margin: 0 0 12px;\n  padding: 0;\n}\n\n.rail_871918107 .searchButton_871918107 {\n  width: 36px;\n  height: 36px;\n  color: var(--dsw-alias-label-primary);\n}\n\n.rail_871918107 .searchButton_871918107:hover {\n  background: var(--dsw-alias-interactive-bg-hover);\n}\n\n.listArea_871918107 {\n  min-height: 0;\n  margin-left: -4px;\n  margin-right: calc(-1 * var(--dsh-session-list-edge-inset));\n  flex-direction: column;\n  flex: 1;\n  padding-left: 4px;\n  display: flex;\n  overflow: visible;\n}\n\n.rail_871918107 .listArea_871918107 {\n  margin-left: 0;\n  margin-right: 0;\n  padding-left: 0;\n}\n\n.treeBody_871918107 {\n  flex-direction: column;\n  flex: 1;\n  min-height: 0;\n  display: flex;\n  position: relative;\n}\n\n.fade_871918107 {\n  left: 0;\n  right: var(--dsh-session-list-edge-inset);\n  background: linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));\n  pointer-events: none;\n  height: 24px;\n  position: absolute;\n  bottom: 0;\n}\n\n.wide_871918107 {\n  animation: wide-in 0.2s var(--ds-ease-in-out);\n}\n\n@keyframes wide-in {\n  0% { opacity: 0; }\n}\n\n.list_871918107 {\n  min-height: 0;\n  margin-left: -4px;\n  margin-right: var(--dsh-session-list-scrollbar-offset);\n  padding-left: 4px;\n  padding-right: calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));\n  scrollbar-gutter: stable;\n  flex: 1;\n  padding-bottom: 16px;\n  overflow-y: auto;\n}\n\n.flatList_871918107 > * + *,\n.searchTree_871918107 > [role=treeitem] + [role=treeitem],\n.groupSection_871918107 > * + * {\n  margin-top: 2px;\n}\n\n.searchStatus_871918107,\n.searchWarning_871918107 {\n  color: var(--dsw-alias-label-tertiary);\n  padding: 10px 12px;\n  font-size: 12px;\n  line-height: 18px;\n}\n\n.searchWarning_871918107 {\n  color: var(--dsw-alias-label-secondary);\n}\n\n.groupSection_871918107 {\n  position: relative;\n}\n\n.groupSection_871918107 + .groupSection_871918107 {\n  margin-top: 4px;\n}\n\n/* P3: workspace drag insertion markers (unused in P2). */\n.listTopDropIndicator_871918107,\n.workspaceDropBefore_871918107:before,\n.workspaceDropAfter_871918107:after {\n  content: \"\";\n  z-index: 1;\n  background:\n    linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat,\n    linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat,\n    linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;\n  pointer-events: none;\n  height: 12px;\n  position: absolute;\n  left: 0;\n  right: 0;\n}\n\n.listTopDropIndicator_871918107 {\n  top: -8px;\n  left: 0;\n  right: var(--dsh-session-list-edge-inset);\n}\n\n.listTopDropActive_871918107 > .workspaceDropBefore_871918107:first-child:before {\n  display: none;\n}\n\n.workspaceDropBefore_871918107:before {\n  top: -8px;\n}\n\n.workspaceDropAfter_871918107:after {\n  bottom: -8px;\n}\n\n.sessionOverflowButton_871918107 {\n  cursor: pointer;\n  text-align: left;\n  width: 100%;\n  height: 28px;\n  color: var(--dsw-alias-label-tertiary);\n  background: 0 0;\n  border: none;\n  border-radius: 8px;\n  padding: 0 12px 0 28px;\n  font-size: 12px;\n}\n\n.groupSection_871918107 > .sessionOverflowButton_871918107 {\n  margin-top: 0;\n}\n\n.sessionOverflowButton_871918107:hover {\n  color: var(--dsw-alias-label-secondary);\n  background: 0 0;\n}\n\n.empty_871918107 {\n  color: var(--dsw-alias-label-tertiary);\n  padding: 16px 12px;\n  font-size: 13px;\n}\n\n.renameInput_871918107 {\n  box-sizing: border-box;\n  border: 0.5px solid var(--dsw-alias-border-l4);\n  width: 100%;\n  height: 44px;\n  color: var(--dsw-alias-label-primary);\n  background: 0 0;\n  border-radius: 22px;\n  outline: none;\n  padding: 7px 14px;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 22px;\n}\n\n.renameInput_871918107:disabled {\n  color: var(--dsw-alias-label-dimmed);\n}\n\n.renameError_871918107 {\n  color: var(--dsw-alias-state-error-primary);\n  margin-top: 8px;\n  font-size: 12px;\n  line-height: 18px;\n}\n\n.deleteAction_871918107:not(:disabled) {\n  color: var(--dsw-alias-state-error-primary);\n}\n\n.deleteStatus_871918107 {\n  color: var(--dsw-alias-label-secondary);\n  font-size: 12px;\n  line-height: 18px;\n}\n\n/* Pre-delete facts of the worktree-removal dialog: one line per fact, the\n * destructive one (uncommitted files die with the folder) in error tone. */\n.removeFacts_871918107 {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n  margin-top: 8px;\n}\n\n.removeFact_871918107 {\n  font-size: 12px;\n  line-height: 18px;\n  color: var(--dsw-alias-label-secondary);\n}\n\n.removeFactWarn_871918107 {\n  color: var(--dsw-alias-state-error-primary);\n}\n\n.modalAction_871918107 {\n  min-width: 72px;\n}\n\n.modalError_871918107,\n.menuStatus_871918107 {\n  margin-top: 8px;\n  font-size: 12px;\n  line-height: 18px;\n}\n\n.modalError_871918107 {\n  color: var(--dsw-alias-state-error-primary);\n}\n\n.menuStatus_871918107 {\n  color: var(--dsw-alias-label-secondary);\n}\n\n/* Aggregation overlay: indent member workspaces and their sessions. */\n.memberIndent_871918107 {\n  margin-left: 16px;\n}\n\n.sessionsIndent_871918107 {\n  margin-left: 8px;\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .wide_871918107 {\n    animation: none;\n  }\n\n  .search_871918107,\n  .sectionLabel_871918107,\n  .searchSlot_871918107,\n  .searchInput_871918107,\n  .headerActions_871918107 {\n    transition: none;\n  }\n}\n";
		...
		var GroupedSidebar_module_default = {
			"module": "module_871918107",
			"css": "css_871918107",
			"root": "root_871918107",
			"rail": "rail_871918107",
			"iconButton": "iconButton_871918107",
			"sectionHeader": "sectionHeader_871918107",
			"sectionLabel": "sectionLabel_871918107",
			"sectionLabelHidden": "sectionLabelHidden_871918107",
			"searchSlot": "searchSlot_871918107",
			"searchSlotExpanded": "searchSlotExpanded_871918107",
			"headerActions": "headerActions_871918107",
			"headerActionsHidden": "headerActionsHidden_871918107",
			"search": "search_871918107",
			"searchExpanded": "searchExpanded_871918107",
			"searchButton": "searchButton_871918107",
			"searchInput": "searchInput_871918107",
			"clearButton": "clearButton_871918107",
			"listArea": "listArea_871918107",
			"treeBody": "treeBody_871918107",
			"fade": "fade_871918107",
			"wide": "wide_871918107",
			"list": "list_871918107",
			"flatList": "flatList_871918107",
			"searchTree": "searchTree_871918107",
			"groupSection": "groupSection_871918107",
			"searchStatus": "searchStatus_871918107",
			"searchWarning": "searchWarning_871918107",
			"listTopDropIndicator": "listTopDropIndicator_871918107",
			"workspaceDropBefore": "workspaceDropBefore_871918107",
			"workspaceDropAfter": "workspaceDropAfter_871918107",
			"listTopDropActive": "listTopDropActive_871918107",
			"sessionOverflowButton": "sessionOverflowButton_871918107",
			"empty": "empty_871918107",
			"renameInput": "renameInput_871918107",
			"renameError": "renameError_871918107",
			"deleteAction": "deleteAction_871918107",
			"deleteStatus": "deleteStatus_871918107",
			"removeFacts": "removeFacts_871918107",
			"removeFact": "removeFact_871918107",
			"removeFactWarn": "removeFactWarn_871918107",
			"modalAction": "modalAction_871918107",
			"modalError": "modalError_871918107",
			"menuStatus": "menuStatus_871918107",
			"memberIndent": "memberIndent_871918107",
			"sessionsIndent": "sessionsIndent_871918107"
		};
		//#endregion
		...
		*/
		...
		function GroupedSidebar(props) {
			...
			const cachedBatch = (0, react.useMemo)(() => loadFactsCache(), [signature]);
			...
			const probedSignature = (0, react.useRef)(void 0);
			(0, react.useEffect)(() => {
