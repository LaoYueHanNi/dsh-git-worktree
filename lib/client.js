window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function ChipConfirm({ anchorRef, ask, confirmLabel, cancelLabel, busy, draft, onDraftChange, draftPlaceholder, draftInvalid, draftHint, onConfirm, onCancel }) {
			...
			* dialog (whichever is showing). */
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				confirmBundle !== null && !menuOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChipConfirm, {
					anchorRef: chipRef,
					...confirmBundle,
					draft: isCutout ? cutoutDraft : void 0,
					onDraftChange: isCutout ? (value) => {
					...
					draftInvalid: isCutout ? !cutoutValid : void 0,
