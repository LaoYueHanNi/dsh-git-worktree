...
import { handleCreateWorktree, handleGetSettings, handlePutSettings, handleStatus, handleSwitch, } from './routes.js';
import { loadSettings, settingsFileOf } from './settings.js';
...
export function apply(ctx) {
    ...
    ctx.inject(['webServer'], (webCtx) => {
        ...
        webCtx.effect(() => webCtx.webServer.register({ kind: 'exact', path: ROUTE_SETTINGS, handler: async (req, res) => {
                try {
